...
def og_script():
    """
    This function is the og functionality of the original script.
    """
...
"""
Function to determine counties where tzraskowski had less votes than in the first round.
"""
def count_trzaskowski_less(file_1, file_2, candidate1, candidate2):
    wyniki_1 = pd.read_csv(file_1, delimiter=';')
    print(wyniki_1)



if __name__ == "__main__":
    count_trzaskowski_less(FILE1_PATH, FILE2_PATH, CANDIDATE_1_NAME, CANDIDATE_2_NAME)